                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto" style="display: flex; justify-content:center; gap: 8vw; list-style: none; font-size: 2em; margin-bottom: -1em; margin-top: 2.3vh;">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" style="text-decoration: none; background-color: #4285f4; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.4); padding: 0.7vw; border-radius: 2vh;" href="{{ route('login') }}">{{ __('Entrar a mi cuenta') }}</a>
                                </li>
                            @endif
